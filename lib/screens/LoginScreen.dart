...
import 'package:complete_women_care/screens/ForgetPassword.dart';
import 'package:complete_women_care/screens/SignUpScreen.dart';
import 'package:complete_women_care/services/AuthService.dart';
import '../AllText.dart';
import '../main.dart';
...
class _LoginScreenState extends State<LoginScreen> {
  ...
  loginIntoAccount(int type) async {
    ...
    if (response != null && response.data['status'] == 1 || response.data['status'] == "1") {
      ...
      //   //    ?
      //   "profile/" + response.data['data']['profile_pic'].toString().split("/").last
      //       // : "doctor/" +
