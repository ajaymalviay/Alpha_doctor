...
class _AutoselectBookAppointmentState extends State<AutoselectBookAppointment> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((value) {
      setState(() {
        ...
        phoneController = TextEditingController(text: value.getString("phone_no"));
      });
    });
  ...
  fetchDoctorsAndServices(dynamic id) async {
    setState(() {
      doctorValue = null;
      serviceValue = null;
    ...
    print("$SERVER_ADDRESS/api/getdoctorandservicebydeptid?department_id=${widget.departmentId}");
