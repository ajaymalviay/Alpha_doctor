...
// import 'package:complete_women_care/modals/GalleryCategory.dart';
// import 'package:complete_women_care/modals/GalleryImagesByCategory.dart';
// import 'package:complete_women_care/modals/GalleryImagesByCategory.dart' as images;
//
...
//     print(Uri.parse("$SERVER_ADDRESS/api/listofgallerycategory"));
...
//     });
//     print("list ${list}");
//     print(Uri.parse("$SERVER_ADDRESS/api/listofimagebycategoryid?album_id=$category"));
...
//     if (response.statusCode == 200 && jsonResponse['status'] == 1) {
//       setState(() {
//         galleryImagesByCategory = GalleryImagesByCategory.fromJson(jsonResponse);
//         print("galleryImagesByCategory.data.data.length ${galleryImagesByCategory.data.data.length}");
